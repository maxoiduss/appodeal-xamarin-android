...
namespace Com.Ogury.ED {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.ogury.ed']/interface[@name='OguryThumbnailAdListener']"
	[Register ("com/ogury/ed/OguryThumbnailAdListener", "", "Com.Ogury.ED.IOguryThumbnailAdListenerInvoker")]
	public partial interface IOguryThumbnailAdListener : global::Com.Ogury.ED.IOguryAdListener {
	}

	[global::Android.Runtime.Register ("com/ogury/ed/OguryThumbnailAdListener", DoNotGenerateAcw=true)]
	internal partial class IOguryThumbnailAdListenerInvoker : global::Java.Lang.Object, IOguryThumbnailAdListener {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/ogury/ed/OguryThumbnailAdListener", typeof (IOguryThumbnailAdListenerInvoker));
		...
		public static IOguryThumbnailAdListener GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IOguryThumbnailAdListener> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.ogury.ed.OguryThumbnailAdListener'.");
			return handle;
		}
		...
		public IOguryThumbnailAdListenerInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Ogury.ED.IOguryThumbnailAdListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.OnAdClicked ();
		}
