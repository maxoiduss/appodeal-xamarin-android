...
namespace Com.Ogury.ED {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.ogury.ed']/interface[@name='OguryBannerAdListener']"
	[Register ("com/ogury/ed/OguryBannerAdListener", "", "Com.Ogury.ED.IOguryBannerAdListenerInvoker")]
	public partial interface IOguryBannerAdListener : global::Com.Ogury.ED.IOguryAdListener {
	}

	[global::Android.Runtime.Register ("com/ogury/ed/OguryBannerAdListener", DoNotGenerateAcw=true)]
	internal partial class IOguryBannerAdListenerInvoker : global::Java.Lang.Object, IOguryBannerAdListener {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/ogury/ed/OguryBannerAdListener", typeof (IOguryBannerAdListenerInvoker));
		...
		public static IOguryBannerAdListener GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IOguryBannerAdListener> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.ogury.ed.OguryBannerAdListener'.");
			return handle;
		}
		...
		public IOguryBannerAdListenerInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Ogury.ED.IOguryBannerAdListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.OnAdClicked ();
		}
