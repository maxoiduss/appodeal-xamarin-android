...
namespace Com.Ogury.ED {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.ogury.ed']/interface[@name='OguryOptinVideoAdListener']"
	[Register ("com/ogury/ed/OguryOptinVideoAdListener", "", "Com.Ogury.ED.IOguryOptinVideoAdListenerInvoker")]
	public partial interface IOguryOptinVideoAdListener : global::Com.Ogury.ED.IOguryAdListener {
		// Metadata.xml XPath method reference: path="/api/package[@name='com.ogury.ed']/interface[@name='OguryOptinVideoAdListener']/method[@name='onAdRewarded' and count(parameter)=1 and parameter[1][@type='com.ogury.ed.OguryReward']]"
		[Register ("onAdRewarded", "(Lcom/ogury/ed/OguryReward;)V", "GetOnAdRewarded_Lcom_ogury_ed_OguryReward_Handler:Com.Ogury.ED.IOguryOptinVideoAdListenerInvoker, AppodealXamarinAndroid")]
		void OnAdRewarded (global::Com.Ogury.ED.OguryReward p0);

	}

	[global::Android.Runtime.Register ("com/ogury/ed/OguryOptinVideoAdListener", DoNotGenerateAcw=true)]
	internal partial class IOguryOptinVideoAdListenerInvoker : global::Java.Lang.Object, IOguryOptinVideoAdListener {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/ogury/ed/OguryOptinVideoAdListener", typeof (IOguryOptinVideoAdListenerInvoker));
		...
		public static IOguryOptinVideoAdListener GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IOguryOptinVideoAdListener> (handle, transfer);
		}

		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'com.ogury.ed.OguryOptinVideoAdListener'.");
			return handle;
		}
		...
		public IOguryOptinVideoAdListenerInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
		...
		static Delegate cb_onAdRewarded_Lcom_ogury_ed_OguryReward_;
#pragma warning disable 0169
		static Delegate GetOnAdRewarded_Lcom_ogury_ed_OguryReward_Handler ()
		{
			if (cb_onAdRewarded_Lcom_ogury_ed_OguryReward_ == null)
				cb_onAdRewarded_Lcom_ogury_ed_OguryReward_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_V) n_OnAdRewarded_Lcom_ogury_ed_OguryReward_);
			return cb_onAdRewarded_Lcom_ogury_ed_OguryReward_;
		}

		static void n_OnAdRewarded_Lcom_ogury_ed_OguryReward_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Ogury.ED.IOguryOptinVideoAdListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			var p0 = global::Java.Lang.Object.GetObject<global::Com.Ogury.ED.OguryReward> (native_p0, JniHandleOwnership.DoNotTransfer);
			__this.OnAdRewarded (p0);
		}
#pragma warning restore 0169

		IntPtr id_onAdRewarded_Lcom_ogury_ed_OguryReward_;
		public unsafe void OnAdRewarded (global::Com.Ogury.ED.OguryReward p0)
		{
			if (id_onAdRewarded_Lcom_ogury_ed_OguryReward_ == IntPtr.Zero)
				id_onAdRewarded_Lcom_ogury_ed_OguryReward_ = JNIEnv.GetMethodID (class_ref, "onAdRewarded", "(Lcom/ogury/ed/OguryReward;)V");
			JValue* __args = stackalloc JValue [1];
			__args [0] = new JValue ((p0 == null) ? IntPtr.Zero : ((global::Java.Lang.Object) p0).Handle);
			JNIEnv.CallVoidMethod (((global::Java.Lang.Object) this).Handle, id_onAdRewarded_Lcom_ogury_ed_OguryReward_, __args);
		}
