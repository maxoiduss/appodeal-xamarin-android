...
namespace Com.Mopub.Mraid {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.mopub.mraid']/class[@name='MraidVideoViewController']"
	[global::Android.Runtime.Register ("com/mopub/mraid/MraidVideoViewController", DoNotGenerateAcw=true)]
	public partial class MraidVideoViewController : global::Com.Mopub.Mobileads.BaseVideoViewController {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/mopub/mraid/MraidVideoViewController", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MraidVideoViewController); }
		}

		protected MraidVideoViewController (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Landroid_os_Bundle_Landroid_os_Bundle_Lcom_mopub_mobileads_BaseVideoViewController_BaseVideoViewControllerListener_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.mopub.mraid']/class[@name='MraidVideoViewController']/constructor[@name='MraidVideoViewController' and count(parameter)=4 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.os.Bundle'] and parameter[3][@type='android.os.Bundle'] and parameter[4][@type='com.mopub.mobileads.BaseVideoViewController.BaseVideoViewControllerListener']]"
		[Register (".ctor", "(Landroid/content/Context;Landroid/os/Bundle;Landroid/os/Bundle;Lcom/mopub/mobileads/BaseVideoViewController$BaseVideoViewControllerListener;)V", "")]
		public unsafe MraidVideoViewController (global::Android.Content.Context p0, global::Android.OS.Bundle p1, global::Android.OS.Bundle p2, global::Com.Mopub.Mobileads.BaseVideoViewController.IBaseVideoViewControllerListener p3)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (MraidVideoViewController)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Landroid/content/Context;Landroid/os/Bundle;Landroid/os/Bundle;Lcom/mopub/mobileads/BaseVideoViewController$BaseVideoViewControllerListener;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Landroid/content/Context;Landroid/os/Bundle;Landroid/os/Bundle;Lcom/mopub/mobileads/BaseVideoViewController$BaseVideoViewControllerListener;)V", __args);
					return;
				}

				if (id_ctor_Landroid_content_Context_Landroid_os_Bundle_Landroid_os_Bundle_Lcom_mopub_mobileads_BaseVideoViewController_BaseVideoViewControllerListener_ == IntPtr.Zero)
					id_ctor_Landroid_content_Context_Landroid_os_Bundle_Landroid_os_Bundle_Lcom_mopub_mobileads_BaseVideoViewController_BaseVideoViewControllerListener_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Landroid/content/Context;Landroid/os/Bundle;Landroid/os/Bundle;Lcom/mopub/mobileads/BaseVideoViewController$BaseVideoViewControllerListener;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Landroid_content_Context_Landroid_os_Bundle_Landroid_os_Bundle_Lcom_mopub_mobileads_BaseVideoViewController_BaseVideoViewControllerListener_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Landroid_content_Context_Landroid_os_Bundle_Landroid_os_Bundle_Lcom_mopub_mobileads_BaseVideoViewController_BaseVideoViewControllerListener_, __args);
			} finally {
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Mopub.Mraid.MraidVideoViewController __this = global::Java.Lang.Object.GetObject<global::Com.Mopub.Mraid.MraidVideoViewController> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		protected override unsafe global::Android.Widget.VideoView VideoView {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.mraid']/class[@name='MraidVideoViewController']/method[@name='getVideoView' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.mraid']/class[@name='MraidVideoViewController']/method[@name='onConfigurationChanged' and count(parameter)=1 and parameter[1][@type='android.content.res.Configuration']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.mraid']/class[@name='MraidVideoViewController']/method[@name='onDestroy' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.mraid']/class[@name='MraidVideoViewController']/method[@name='onPause' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.mraid']/class[@name='MraidVideoViewController']/method[@name='onResume' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.mraid']/class[@name='MraidVideoViewController']/method[@name='onSaveInstanceState' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
