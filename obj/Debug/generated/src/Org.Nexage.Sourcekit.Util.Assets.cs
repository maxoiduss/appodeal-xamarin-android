...
namespace Org.Nexage.Sourcekit.Util {
	...
	public partial class Assets : global::Java.Lang.Object {
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (Assets); }
		}

		protected Assets (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.nexage.sourcekit.util']/class[@name='Assets']/constructor[@name='Assets' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe Assets ()
		...
		static IntPtr id_getDrawableFromBase64_Landroid_content_res_Resources_Ljava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.nexage.sourcekit.util']/class[@name='Assets']/method[@name='getDrawableFromBase64' and count(parameter)=2 and parameter[1][@type='android.content.res.Resources'] and parameter[2][@type='java.lang.String']]"
		[Register ("getDrawableFromBase64", "(Landroid/content/res/Resources;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;", "")]
		public static unsafe global::Android.Graphics.Drawables.Drawable GetDrawableFromBase64 (global::Android.Content.Res.Resources p0, string p1)
		{
			if (id_getDrawableFromBase64_Landroid_content_res_Resources_Ljava_lang_String_ == IntPtr.Zero)
				id_getDrawableFromBase64_Landroid_content_res_Resources_Ljava_lang_String_ = JNIEnv.GetStaticMethodID (class_ref, "getDrawableFromBase64", "(Landroid/content/res/Resources;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;");
			IntPtr native_p1 = JNIEnv.NewString (p1);
			try {
				JValue* __args = stackalloc JValue [2];
				__args [0] = new JValue (p0);
				__args [1] = new JValue (native_p1);
				global::Android.Graphics.Drawables.Drawable __ret = global::Java.Lang.Object.GetObject<global::Android.Graphics.Drawables.Drawable> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getDrawableFromBase64_Landroid_content_res_Resources_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
