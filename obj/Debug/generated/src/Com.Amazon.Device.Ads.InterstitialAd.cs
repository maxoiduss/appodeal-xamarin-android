...
namespace Com.Amazon.Device.Ads {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']"
	[global::Android.Runtime.Register ("com/amazon/device/ads/InterstitialAd", DoNotGenerateAcw=true)]
	public partial class InterstitialAd : global::Java.Lang.Object, global::Com.Amazon.Device.Ads.IAd {


		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='ACTION_INTERSTITIAL_DISMISSED']"
		[Register ("ACTION_INTERSTITIAL_DISMISSED")]
		protected const string ActionInterstitialDismissed = (string) "dismissed";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='ACTION_INTERSTITIAL_FINISHED_LOADING']"
		[Register ("ACTION_INTERSTITIAL_FINISHED_LOADING")]
		protected const string ActionInterstitialFinishedLoading = (string) "finished";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='BROADCAST_ACTION']"
		[Register ("BROADCAST_ACTION")]
		protected const string BroadcastAction = (string) "action";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='BROADCAST_CREATIVE']"
		[Register ("BROADCAST_CREATIVE")]
		protected const string BroadcastCreative = (string) "creative";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='BROADCAST_INTENT']"
		[Register ("BROADCAST_INTENT")]
		protected const string BroadcastIntent = (string) "amazon.mobile.ads.interstitial";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='BROADCAST_UNIQUE_IDENTIFIER_KEY']"
		[Register ("BROADCAST_UNIQUE_IDENTIFIER_KEY")]
		protected const string BroadcastUniqueIdentifierKey = (string) "uniqueIdentifier";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='MSG_PREPARE_AD_DESTROYED']"
		[Register ("MSG_PREPARE_AD_DESTROYED")]
		protected const string MsgPrepareAdDestroyed = (string) "This interstitial ad has been destroyed and can no longer be used. Create a new InterstitialAd object to load a new ad.";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='MSG_PREPARE_AD_LOADING']"
		[Register ("MSG_PREPARE_AD_LOADING")]
		protected const string MsgPrepareAdLoading = (string) "An interstitial ad is currently loading. Please wait for the ad to finish loading and showing before loading another ad.";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='MSG_PREPARE_AD_READY_TO_SHOW']"
		[Register ("MSG_PREPARE_AD_READY_TO_SHOW")]
		protected const string MsgPrepareAdReadyToShow = (string) "An interstitial ad is ready to show. Please call showAd() to show the ad before loading another ad.";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='MSG_PREPARE_AD_SHOWING']"
		[Register ("MSG_PREPARE_AD_SHOWING")]
		protected const string MsgPrepareAdShowing = (string) "An interstitial ad is currently showing. Please wait for the user to dismiss the ad before loading an ad.";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='MSG_SHOW_AD_ANOTHER_SHOWING']"
		[Register ("MSG_SHOW_AD_ANOTHER_SHOWING")]
		protected const string MsgShowAdAnotherShowing = (string) "Another interstitial ad is currently showing. Please wait for the InterstitialAdListener.onAdDismissed callback of the other ad.";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='MSG_SHOW_AD_DESTROYED']"
		[Register ("MSG_SHOW_AD_DESTROYED")]
		protected const string MsgShowAdDestroyed = (string) "The interstitial ad cannot be shown because it has been destroyed. Create a new InterstitialAd object to load a new ad.";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='MSG_SHOW_AD_DISMISSED']"
		[Register ("MSG_SHOW_AD_DISMISSED")]
		protected const string MsgShowAdDismissed = (string) "The interstitial ad cannot be shown because it has already been displayed to the user. Please call loadAd(AdTargetingOptions) to load a new ad.";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='MSG_SHOW_AD_EXPIRED']"
		[Register ("MSG_SHOW_AD_EXPIRED")]
		protected const string MsgShowAdExpired = (string) "This interstitial ad has expired. Please load another ad.";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='MSG_SHOW_AD_LOADING']"
		[Register ("MSG_SHOW_AD_LOADING")]
		protected const string MsgShowAdLoading = (string) "The interstitial ad cannot be shown because it is still loading. Please wait for the AdListener.onAdLoaded() callback before showing the ad.";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='MSG_SHOW_AD_READY_TO_LOAD']"
		[Register ("MSG_SHOW_AD_READY_TO_LOAD")]
		protected const string MsgShowAdReadyToLoad = (string) "The interstitial ad cannot be shown because it has not loaded successfully. Please call loadAd(AdTargetingOptions) to load an ad first.";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/field[@name='MSG_SHOW_AD_SHOWING']"
		[Register ("MSG_SHOW_AD_SHOWING")]
		protected const string MsgShowAdShowing = (string) "The interstitial ad cannot be shown because it is already displayed on the screen. Please wait for the InterstitialAdListener.onAdDismissed() callback and then load a new ad.";
		// Metadata.xml XPath class reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd.InterstitialAdControlCallback']"
		[global::Android.Runtime.Register ("com/amazon/device/ads/InterstitialAd$InterstitialAdControlCallback", DoNotGenerateAcw=true)]
		public partial class InterstitialAdControlCallback : global::Java.Lang.Object, global::Com.Amazon.Device.Ads.IAdControlCallback {
			...
			internal static IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("com/amazon/device/ads/InterstitialAd$InterstitialAdControlCallback", ref java_class_handle);
				}
			}
			...
			protected override global::System.Type ThresholdType {
				get { return typeof (InterstitialAdControlCallback); }
			}

			protected InterstitialAdControlCallback (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}
...
#pragma warning disable 0169
			...
			{
				global::Com.Amazon.Device.Ads.InterstitialAd.InterstitialAdControlCallback __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Device.Ads.InterstitialAd.InterstitialAdControlCallback> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				return __this.AdClosing ();
			}
#pragma warning restore 0169

			static IntPtr id_adClosing;
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd.InterstitialAdControlCallback']/method[@name='adClosing' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd.InterstitialAdControlCallback']/method[@name='isAdReady' and count(parameter)=1 and parameter[1][@type='boolean']]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd.InterstitialAdControlCallback']/method[@name='onAdExpired' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd.InterstitialAdControlCallback']/method[@name='onAdFailed' and count(parameter)=1 and parameter[1][@type='com.amazon.device.ads.AdError']]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd.InterstitialAdControlCallback']/method[@name='onAdLoaded' and count(parameter)=1 and parameter[1][@type='com.amazon.device.ads.AdProperties']]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd.InterstitialAdControlCallback']/method[@name='onAdRendered' and count(parameter)=0]"
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd.InterstitialAdControlCallback']/method[@name='postAdRendered' and count(parameter)=0]"
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/amazon/device/ads/InterstitialAd", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/constructor[@name='InterstitialAd' and count(parameter)=1 and parameter[1][@type='android.app.Activity']]"
		[Register (".ctor", "(Landroid/app/Activity;)V", "")]
		public unsafe InterstitialAd (global::Android.App.Activity p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				if (GetType () != typeof (InterstitialAd)) {
					SetHandle (
		...
		static IntPtr id_isAdShowing;
		public static unsafe bool IsAdShowing {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/method[@name='isAdShowing' and count(parameter)=0]"
			[Register ("isAdShowing", "()Z", "GetIsAdShowingHandler")]
			get {
				if (id_isAdShowing == IntPtr.Zero)
					id_isAdShowing = JNIEnv.GetStaticMethodID (class_ref, "isAdShowing", "()Z");
				try {
					return JNIEnv.CallStaticBooleanMethod  (class_ref, id_isAdShowing);
				} finally {
				}
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Amazon.Device.Ads.InterstitialAd __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Device.Ads.InterstitialAd> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsLoading {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/method[@name='isLoading' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsReady {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/method[@name='isReady' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool IsShowing {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/method[@name='isShowing' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int Timeout {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/method[@name='getTimeout' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/method[@name='setTimeout' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/method[@name='loadAd' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/method[@name='loadAd' and count(parameter)=1 and parameter[1][@type='com.amazon.device.ads.AdTargetingOptions']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/method[@name='setListener' and count(parameter)=1 and parameter[1][@type='com.amazon.device.ads.AdListener']]"
		...
		static Delegate cb_showAd;
#pragma warning disable 0169
		static Delegate GetShowAdHandler ()
		{
			if (cb_showAd == null)
				cb_showAd = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, bool>) n_ShowAd);
			return cb_showAd;
		}

		static bool n_ShowAd (IntPtr jnienv, IntPtr native__this)
		{
			global::Com.Amazon.Device.Ads.InterstitialAd __this = global::Java.Lang.Object.GetObject<global::Com.Amazon.Device.Ads.InterstitialAd> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.ShowAd ();
		}
#pragma warning restore 0169

		static IntPtr id_showAd;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.amazon.device.ads']/class[@name='InterstitialAd']/method[@name='showAd' and count(parameter)=0]"
		[Register ("showAd", "()Z", "GetShowAdHandler")]
		public virtual unsafe bool ShowAd ()
		{
			if (id_showAd == IntPtr.Zero)
				id_showAd = JNIEnv.GetMethodID (class_ref, "showAd", "()Z");
			try {

				if (GetType () == ThresholdType)
					return JNIEnv.CallBooleanMethod  (Handle, id_showAd);
				else
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "showAd", "()Z"));
			} finally {
			}
		}
