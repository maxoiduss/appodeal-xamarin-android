...
namespace Com.Mopub.Mobileads.Factories {
	...
	public partial class VastManagerFactory : global::Java.Lang.Object {
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (VastManagerFactory)) {
					SetHandle (
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.mobileads.factories']/class[@name='VastManagerFactory']/method[@name='create' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register ("create", "(Landroid/content/Context;)Lcom/mopub/mobileads/VastManager;", "")]
		public static unsafe global::Com.Mopub.Mobileads.VastManager Create (global::Android.Content.Context p0)
		{
			if (id_create_Landroid_content_Context_ == IntPtr.Zero)
				id_create_Landroid_content_Context_ = JNIEnv.GetStaticMethodID (class_ref, "create", "(Landroid/content/Context;)Lcom/mopub/mobileads/VastManager;");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Com.Mopub.Mobileads.VastManager __ret = global::Java.Lang.Object.GetObject<global::Com.Mopub.Mobileads.VastManager> (JNIEnv.CallStaticObjectMethod  (class_ref, id_create_Landroid_content_Context_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Mopub.Mobileads.Factories.VastManagerFactory __this = global::Java.Lang.Object.GetObject<global::Com.Mopub.Mobileads.Factories.VastManagerFactory> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.mopub.mobileads.factories']/class[@name='VastManagerFactory']/method[@name='internalCreate' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register ("internalCreate", "(Landroid/content/Context;)Lcom/mopub/mobileads/VastManager;", "GetInternalCreate_Landroid_content_Context_Handler")]
		public virtual unsafe global::Com.Mopub.Mobileads.VastManager InternalCreate (global::Android.Content.Context p0)
		{
			if (id_internalCreate_Landroid_content_Context_ == IntPtr.Zero)
				id_internalCreate_Landroid_content_Context_ = JNIEnv.GetMethodID (class_ref, "internalCreate", "(Landroid/content/Context;)Lcom/mopub/mobileads/VastManager;");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				global::Com.Mopub.Mobileads.VastManager __ret;
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Com.Mopub.Mobileads.VastManager> (JNIEnv.CallObjectMethod  (Handle, id_internalCreate_Landroid_content_Context_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Com.Mopub.Mobileads.VastManager> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "internalCreate", "(Landroid/content/Context;)Lcom/mopub/mobileads/VastManager;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
