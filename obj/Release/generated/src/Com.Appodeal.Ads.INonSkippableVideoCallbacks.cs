...
namespace Com.Appodeal.Ads {
	...
	public partial interface INonSkippableVideoCallbacks : IJavaObject {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.appodeal.ads']/interface[@name='NonSkippableVideoCallbacks']/method[@name='onNonSkippableVideoClosed' and count(parameter)=0]"
		[Register ("onNonSkippableVideoClosed", "()V", "GetOnNonSkippableVideoClosedHandler:Com.Appodeal.Ads.INonSkippableVideoCallbacksInvoker, AppodealXamarinPlugin")]
	...
	internal class INonSkippableVideoCallbacksInvoker : global::Java.Lang.Object, INonSkippableVideoCallbacks {
		...
		static Delegate cb_onNonSkippableVideoClosed;
#pragma warning disable 0169
		static Delegate GetOnNonSkippableVideoClosedHandler ()
		{
			if (cb_onNonSkippableVideoClosed == null)
				cb_onNonSkippableVideoClosed = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr>) n_OnNonSkippableVideoClosed);
			return cb_onNonSkippableVideoClosed;
		}

		static void n_OnNonSkippableVideoClosed (IntPtr jnienv, IntPtr native__this)
		{
			...
			__this.OnNonSkippableVideoClosed ();
		}
#pragma warning restore 0169

		IntPtr id_onNonSkippableVideoClosed;
		public unsafe void OnNonSkippableVideoClosed ()
		{
			if (id_onNonSkippableVideoClosed == IntPtr.Zero)
				id_onNonSkippableVideoClosed = JNIEnv.GetMethodID (class_ref, "onNonSkippableVideoClosed", "()V");
			JNIEnv.CallVoidMethod (Handle, id_onNonSkippableVideoClosed);
		}
