...
namespace Com.Appodeal.Ads {
	...
	public partial interface INativeCallbacks : IJavaObject {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.appodeal.ads']/interface[@name='NativeCallbacks']/method[@name='onNativeLoaded' and count(parameter)=0]"
		[Register ("onNativeLoaded", "()V", "GetOnNativeLoadedHandler:Com.Appodeal.Ads.INativeCallbacksInvoker, AppodealXamarinPlugin")]
		void OnNativeLoaded ();
...
#pragma warning restore 0169
		...
		IntPtr id_onNativeLoaded;
		public unsafe void OnNativeLoaded ()
		{
