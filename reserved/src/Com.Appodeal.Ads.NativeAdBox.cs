		...
		public virtual unsafe global::System.Collections.Generic.IList<global::Com.Appodeal.Ads.INativeAd> GetNativeAds (int p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					return global::Android.Runtime.JavaList<global::Com.Appodeal.Ads.INativeAd>.FromJniHandle (JNIEnv.CallObjectMethod  (Handle, id_getNativeAds_I, __args), JniHandleOwnership.TransferLocalRef);
				else
					return global::Android.Runtime.JavaList<global::Com.Appodeal.Ads.INativeAd>.FromJniHandle (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getNativeAds", "(I)Ljava/util/List;"), __args), JniHandleOwnership.TransferLocalRef);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		public virtual unsafe void SetListener (global::Com.Appodeal.Ads.INativeAdBoxListener p0)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setListener_Lcom_appodeal_ads_NativeAdBoxListener_, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setListener", "(Lcom/appodeal/ads/NativeAdBoxListener;)V"), __args);
			} finally {
			}
		}
