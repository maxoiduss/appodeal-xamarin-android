...
namespace Com.Appodeal.Ads {
	...
	public partial interface IAppodealRequestCallbacks : IJavaObject {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.appodeal.ads']/interface[@name='AppodealRequestCallbacks']/method[@name='onRequestStart' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String']]"
		[Register ("onRequestStart", "(ILjava/lang/String;)V", "GetOnRequestStart_ILjava_lang_String_Handler:Com.Appodeal.Ads.IAppodealRequestCallbacksInvoker, AppodealXamarinPlugin")]
		void OnRequestStart (int p0, string p1);
...
#pragma warning restore 0169
		...
		public unsafe void OnRequestFinish (int p0, string p1, bool p2)
		{
			...
			JNIEnv.CallVoidMethod (Handle, id_onRequestFinish_ILjava_lang_String_Z, __args);
			JNIEnv.DeleteLocalRef (native_p1);
		}

		static Delegate cb_onRequestStart_ILjava_lang_String_;
#pragma warning disable 0169
		static Delegate GetOnRequestStart_ILjava_lang_String_Handler ()
		{
			if (cb_onRequestStart_ILjava_lang_String_ == null)
				cb_onRequestStart_ILjava_lang_String_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, int, IntPtr>) n_OnRequestStart_ILjava_lang_String_);
			return cb_onRequestStart_ILjava_lang_String_;
		}

		static void n_OnRequestStart_ILjava_lang_String_ (IntPtr jnienv, IntPtr native__this, int p0, IntPtr native_p1)
		{
			global::Com.Appodeal.Ads.IAppodealRequestCallbacks __this = global::Java.Lang.Object.GetObject<global::Com.Appodeal.Ads.IAppodealRequestCallbacks> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			string p1 = JNIEnv.GetString (native_p1, JniHandleOwnership.DoNotTransfer);
			__this.OnRequestStart (p0, p1);
		}
#pragma warning restore 0169

		IntPtr id_onRequestStart_ILjava_lang_String_;
		public unsafe void OnRequestStart (int p0, string p1)
		{
			if (id_onRequestStart_ILjava_lang_String_ == IntPtr.Zero)
				id_onRequestStart_ILjava_lang_String_ = JNIEnv.GetMethodID (class_ref, "onRequestStart", "(ILjava/lang/String;)V");
			IntPtr native_p1 = JNIEnv.NewString (p1);
			JValue* __args = stackalloc JValue [2];
			__args [0] = new JValue (p0);
			__args [1] = new JValue (native_p1);
			JNIEnv.CallVoidMethod (Handle, id_onRequestStart_ILjava_lang_String_, __args);
			JNIEnv.DeleteLocalRef (native_p1);
		}
...
#pragma warning restore 0169
		...
		public unsafe void OnWaterfallFinish (int p0, bool p1)
		{
			...
			JNIEnv.CallVoidMethod (Handle, id_onWaterfallFinish_IZ, __args);
		}
...
#pragma warning restore 0169
		...
		public unsafe void OnWaterfallStart (int p0)
		{
			...
			__args [0] = new JValue (p0);
			JNIEnv.CallVoidMethod (Handle, id_onWaterfallStart_I, __args);
		}
