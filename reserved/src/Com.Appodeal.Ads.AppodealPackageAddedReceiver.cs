...
namespace Com.Appodeal.Ads {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.appodeal.ads']/class[@name='AppodealPackageAddedReceiver']"
	[global::Android.Runtime.Register ("com/appodeal/ads/AppodealPackageAddedReceiver", DoNotGenerateAcw=true)]
	public partial class AppodealPackageAddedReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/appodeal/ads/AppodealPackageAddedReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AppodealPackageAddedReceiver); }
		}

		protected AppodealPackageAddedReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.appodeal.ads']/class[@name='AppodealPackageAddedReceiver']/constructor[@name='AppodealPackageAddedReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AppodealPackageAddedReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (AppodealPackageAddedReceiver)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Appodeal.Ads.AppodealPackageAddedReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Appodeal.Ads.AppodealPackageAddedReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.appodeal.ads']/class[@name='AppodealPackageAddedReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
