...
namespace Com.Appodeal.Ads {
	...
	public partial interface IRewardedVideoCallbacks : IJavaObject {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.appodeal.ads']/interface[@name='RewardedVideoCallbacks']/method[@name='onRewardedVideoClosed' and count(parameter)=0]"
		[Register ("onRewardedVideoClosed", "()V", "GetOnRewardedVideoClosedHandler:Com.Appodeal.Ads.IRewardedVideoCallbacksInvoker, AppodealXamarinPlugin")]
	...
	internal class IRewardedVideoCallbacksInvoker : global::Java.Lang.Object, IRewardedVideoCallbacks {
		...
		static Delegate cb_onRewardedVideoClosed;
#pragma warning disable 0169
		static Delegate GetOnRewardedVideoClosedHandler ()
		{
			if (cb_onRewardedVideoClosed == null)
				cb_onRewardedVideoClosed = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr>) n_OnRewardedVideoClosed);
			return cb_onRewardedVideoClosed;
		}

		static void n_OnRewardedVideoClosed (IntPtr jnienv, IntPtr native__this)
		{
			...
			__this.OnRewardedVideoClosed ();
		}
#pragma warning restore 0169

		IntPtr id_onRewardedVideoClosed;
		public unsafe void OnRewardedVideoClosed ()
		{
			if (id_onRewardedVideoClosed == IntPtr.Zero)
				id_onRewardedVideoClosed = JNIEnv.GetMethodID (class_ref, "onRewardedVideoClosed", "()V");
			JNIEnv.CallVoidMethod (Handle, id_onRewardedVideoClosed);
		}
